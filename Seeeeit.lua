...
function Library.xova()
	...
	Logo.Image = "rbxassetid://10802484607"
	...
	Description.Text = "Fucked Script For Everyone"
	...
	New.Position = UDim2.new(0.460000008, 0, 0.5, 0)
	New.Size = UDim2.new(0, 27, 0, 27)
	New.Image = "http://www.roblox.com/asset/?id=6026647930"
	...
	function Library.Notifcation(options)
		...
		ButtonBar.BackgroundColor3 = Color3.fromRGB(0, 153, 153)
		...
		LineMain.BackgroundColor3 = Color3.fromRGB(255, 0, 127)
	...
	function LibraryTab.create(Title)
		...
		function LibraryPage.xovapage(Type)
			...
			function LibraryFunction.Label(options)
				...
				local visual = options.Title or "Label : nil"
			...
			function LibraryFunction.Toggle(options)
				...
				if visualMode == 1 then
					...
					ToggleInner.ImageColor3 = Color3.fromRGB(255, 0, 127)
			...
			function LibraryFunction.TextBox(options)
				...
				local visualTitle = options.Title or "TextBox : nil"
				local PlaceText = options.PlaceHolder or "Place Here!"
				...
				TextBoxFrame.Parent = PageFrameMain
				TextBoxFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
				TextBoxFrame.BorderColor3 = Color3.fromRGB(27, 42, 53)
				TextBoxFrame.BorderSizePixel = 0
				TextBoxFrame.Position = UDim2.new(0, 0, 0.774193525, 0)
				TextBoxFrame.Size = UDim2.new(0, 225, 0, 61)
				...
				TextBoxTitle.Text = visualTitle
				TextBoxTitle.Name = "TextBoxTitle"
				TextBoxTitle.Parent = TextBoxFrame
				TextBoxTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				TextBoxTitle.BackgroundTransparency = 1.000
				TextBoxTitle.Position = UDim2.new(0.0488888882, 0, 0, 0)
				TextBoxTitle.Size = UDim2.new(0, 170, 0, 29)
				TextBoxTitle.Font = Enum.Font.GothamMedium
				TextBoxTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
				TextBoxTitle.TextSize = 12.000
				TextBoxTitle.TextTransparency = 0.500
				...
				TextBox.BorderSizePixel = 0
				TextBox.Position = UDim2.new(0.0219999999, 0, 0.460000008, 0)
				TextBox.Size = UDim2.new(0, 215, 0, 26)
